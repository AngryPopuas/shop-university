...
const ProductListPreviewSkeleton = () => {
    return (
        <div className='grid grid-cols-4 gap-y-5 w-full'>
            {new Array(12).fill(0, 0, 12).map((item) => {
                return (
                    <div className='flex flex-col justify-between items-center rounded-md transition-all bg-transparent p-[5px] space-y-[10px] w-[270px]'>
